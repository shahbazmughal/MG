...
import { Container, Flex, Box, css, Input, Button, Textarea } from 'theme-ui'
...
const Contacts = () => {
  ...
  const handleServerResponse = (ok, msg, form) => {
      ...
      if (ok) {
        form.reset();
        setLoader(false);
        setState({ ...state,  fullname:"", email: "", phoneno: "", subject:"", message:"", valid_fullname: "", valid_email: "", valid_phoneno:"", valid_subject: "", valid_message: "", nameMsg:"hide", emailMsg:"hide", phoneMsg:"hide", subjectMsg:"hide", messageMsg:"hide", toast:true});
  ...
  const handleOnSubmit = e => {
    ...
    axios({
      method: "post",
      //url: "https://getform.io/f/bc215e06-cd8a-45f6-849b-9615a627f01d",
      url: "https://shahbaz.dev.jt.hostingshouse.com/projects/php/contact/curl.php",
          ...
          <form onSubmit={handleOnSubmit} method='post' class="contact-us-form">
            ...
            <Box style={styles.wrow}>
              ...
              <Box  style={styles.w50}>
                ...
                <span className={`error-block error `+state.subjectMsg}>Phone No is required</span>
              </Box>
