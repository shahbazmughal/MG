            ...
            <div className="container aos-init aos-animate" data-aos="fade-up">
              <div className="row gy-4 step1 row aos-init aos-animate" id="newPriceBlk" data-aos="fade-left">
                ...
                <div className="col-md-4 base-block">
                  ...
                  <p> <a href="https://one.mumara.com/signup?pid=57" id="buy" className="btn btn-success btn-sm">Order Now</a><a href="#" id="seeBrDwn" rel="noopener noreferrer" data-toggle="modal" data-target=".fusion-modal.seeBrDwn">See Cost Breakdown</a> </p>
                </div>
              </div>
            </div>
          </section>
