      ...
      <div className="row">
        ...
        <div className="col-md-10 mb-20">
          <div className="step-content text-white text-left">
              ...
              <p>If you plan to host it on your server, you’ll be allocated an instant License and able to download Mumara right after the purchase. Mumara installation guide and methods can be <Link to="https://docs.mumara.com/Campaigns/Getting-Started/Installation-Guide">found here.</Link></p>
          </div>
        </div>
      </div>
