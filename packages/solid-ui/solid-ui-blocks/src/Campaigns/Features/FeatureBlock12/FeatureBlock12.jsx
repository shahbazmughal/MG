...
const FeatureBlock12 = ({ content: { text, buttons, form, images, html } }) => (
  <div className="pt-40 pb-20 features4" id="features12">
    <div className="container">
      ...
      <h2 className=" text-40 text-yellow text-center pt-40">Email Journey Starts with Few Simple Clicks</h2>
      ...
      <div className="row pt-50 pb-40">
        <div className="col-md-6 col-md-offset-3">
          <div className="cta-box text-center pb-0 pt-40">
            ...
            <div className="pb-0">
              <div className="css-12g6cok text-block">
                <Link to="./#orderarea" className="button-group-button level-1 css-12g6cok css-12hibeq text-block">
                  ORDER NOW
                </Link>
              </div>
              <div className="p-20">
