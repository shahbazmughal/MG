...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Dynamic Content Tag | Behavioral Targeting | MumaraClassic' description="One of the important aspects of creating relevant content is to follow some solid content personalization methods, dynamic content is among one of these." keywords="dynamic content,content personalization,create dynamic content,behavioral marketing" />
        {/* Blocks */}
...
export const query = graphql`
  query classicFeaturesPage3BlockContent {
    allBlockContent(
      filter: { page: { in: ["classic/features/dynamic-content-tags", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
