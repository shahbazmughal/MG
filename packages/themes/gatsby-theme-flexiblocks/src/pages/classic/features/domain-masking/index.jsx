...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Domain Masking | Domain Forwarding | MumaraClassic' description="The addon offers an easy way to hide the identity of primary (Installation) domain, by seamlessly replacing the primary domain URL with another pointer domain URL." keywords="domain masking,mask forwarding option,cname,url masking,dns redirect,htaccess direct" />
        {/* Blocks */}
