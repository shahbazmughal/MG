...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Email Autoresponder | Trigger Event | MumaraClassic' description="Create email autoresponders and setup trigger events for sales prospecting and workflow automation." keywords="automatic email response,workflow automation,trigger events,sales prospecting,email automation" />
        {/* Blocks */}
...
export const query = graphql`
  query classicFeaturesPage15BlockContent {
    allBlockContent(
      filter: { page: { in: ["classic/features/email-automation", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
