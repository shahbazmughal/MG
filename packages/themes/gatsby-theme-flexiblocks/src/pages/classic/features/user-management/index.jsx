...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='User Accounts & Access Management | MumaraClassic' description="Setup user groups with complete access management control that later will be used to add user accounts." keywords="user management,access management,access control level,user accounts,user permission" />
        {/* Blocks */}
...
export const query = graphql`
  query classicFeaturesPage8BlockContent {
    allBlockContent(
      filter: { page: { in: ["classic/features/user-management", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
