...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Email Marketing Segmentation | Export Contacts | MumaraClassic' description="Use segmentation to create more targeted groups of contacts with similar characteristics or behavioral pattern, export CSV or move the contacts to another list." keywords="email marketing segmentation,sort and filter email data,export csv,email list segmentation" />
        {/* Blocks */}
