...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='AdStation by AdKnowledge | AdStation Emails | MumaraClassic' description="Easily configure your publisher account provided by AdStation Integrated, schedule, segment, send and monitor AdStation Emails for higher CTR." keywords="adstation by adknowledge,adstation integrated addon,mumara adstation,send adstation emails,adstation sending" />
        {/* Blocks */}
...
export const query = graphql`
  query classicFeaturesPage10BlockContent {
    allBlockContent(
      filter: { page: { in: ["classic/features/adstation-integrated", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
