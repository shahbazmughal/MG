...
export const query = graphql`
  query classicFeaturesPage9BlockContent {
    allBlockContent(
      filter: { page: { in: ["classic/features/reputation-monitoring", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
