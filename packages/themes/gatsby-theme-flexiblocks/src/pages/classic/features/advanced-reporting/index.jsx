...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Email Analytics | Geo Location Tool | MumaraClassic' description="Who has unsubscribed from the list? Who is opening email and who has clicked the link and from which location, learn every important metric about the sent campaigns." keywords="email analytics,email tracker,email analytics tool,email tracking app,track email opens,click email count" />
        {/* Blocks */}
