...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='White Label Email Sending | SMS' description="Appropriately setting up the client account for white label sending would enable the client account to send the emails from his/her preferred sending domain, instead of using the domain of Email Service Provider." keywords="white label sending,email authentication,generate dkim,generate spf,bounce notification email" />
        {/* Blocks */}
