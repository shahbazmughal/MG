...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Add IPs to Server | Assign IPs | SMS' description="Select a sending server, and conveniently add IP or IP blocks by following the set pattern.You are provided with a central control to manage all the IPs and IP blocks belonging to multiple servers." keywords="ips management,add ip blocks,manage mail sending ips,sender ip,shared ips,dedicated ips" />
        {/* Blocks */}
...
export const query = graphql`
  query classicESPFeaturesPage2BlockContent {
    allBlockContent(
      filter: { page: { in: ["classic-esp/manage-ips-ip-blocks", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
