...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Gateway Redundancy | Priority Zone | SMS' description="Setup gateway priority for geographically distributed zones and networks operating within these countries to effectively cut the text message cost." keywords="destination zones,sending priority zones,cut text message cost,network priority" />
        {/* Blocks */}
...
export const query = graphql`
  query smsPlusFeaturesPage2BlockContent {
    allBlockContent(
      filter: { page: { in: ["smsplus/priority-zones", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
