...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='SMS Package & Pricing Plan | SMS' description="Setup SMS package and pricing plan most suitable according to the scope of your business, you can offer topup or credit plan or monthly subscription package to your clients." keywords="sms package,sms pricing plan,top up online,credit recharge,monthly subscription" />
        {/* Blocks */}
