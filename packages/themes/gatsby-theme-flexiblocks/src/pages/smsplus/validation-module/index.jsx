...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Reverse Lookup Service | SMS' description="SMSPlus is all set for the administrator to offer the clients with integrated reverse lookup service that eventually would benefit admin to make network based priority work." keywords="reverse lookup service,minimize message send failure,identify mobile carrier,network based priority" />
        {/* Blocks */}
...
export const query = graphql`
  query smsPlusFeaturesPage3BlockContent {
    allBlockContent(
      filter: { page: { in: ["smsplus/validation-module", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
