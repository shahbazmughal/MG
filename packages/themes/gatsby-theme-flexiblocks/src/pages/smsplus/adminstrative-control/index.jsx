...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Administrator Dashboard | Admin Settings | SMS' description="The admin side of SMSplus offers comprehensive dashboard with additional to extensive admin settings and parental controls to manage the application well." keywords="administrator dashboard,application settings,smsplus,easy navigation,admin settings" />
        {/* Blocks */}
...
export const query = graphql`
  query smsPlusFeaturesPage1BlockContent {
    allBlockContent(
      filter: { page: { in: ["smsplus/adminstrative-control", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
