...
const campFeaturesProfileManagement = props => {
...
export const query = graphql`
  query campFeaturesProfileManagementBlockContent {
    allBlockContent(
      filter: { page: { in: ["campaigns/features/profile-management", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
...
`
export default campFeaturesProfileManagement
