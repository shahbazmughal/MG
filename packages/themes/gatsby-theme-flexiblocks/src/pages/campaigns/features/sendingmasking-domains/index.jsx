...
export const query = graphql`
  query campFeatures16BlockContent {
    allBlockContent(
      filter: { page: { in: ["campaigns/features/sendingmasking-domains", "shared"] } }
    ) {
      nodes {
        ...BlockContent
      }
