...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='List and Contact Management | SMS' description="Don't need a separate contact manager to keep and manage contacts. MumaraSMS offers an integrated structure to create lists & manage contact information." keywords="contact management,contact information,contact list,custom fields,contact manager,import contacts" />
        {/* Blocks */}
