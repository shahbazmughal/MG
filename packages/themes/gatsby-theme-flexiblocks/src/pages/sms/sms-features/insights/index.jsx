...
const IndexPage = props => {
  ...
  return (
    <Layout theme={theme} {...props} xs={styles.body}>
      ...
      <Seo title='Delivery Reports for Text Messages | SMS' description="Get delivery reports for the text message campaigns.Learn about success rate and message send failure along with the detailed logs." keywords="sms report,sms delivery report,text message fails,message send failure,delivery report for text messages,message logs" />
        {/* Blocks */}
